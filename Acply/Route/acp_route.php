...
class Acp_route extends Acp_base
{
    ...
    /**
         ...
         * @return void
         */
    private static function logDetail($class, $method, $result)
    {
    ...
    /**
         ...
         * @param string $result 发生错误的原因描述
         */
    private static function notFound($class, $method, $result)
    {
    ...
    /**
         ...
         * @throws Acp_error
         */
    public static function relay($class, $originMethod)
    {
