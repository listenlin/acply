...
class Acp_response extends Acp_base
{
    ...
    /**
         ...
         */
    public static function echoJSON($return = false)
    {
    ...
    /**
         ...
         * @return void string
         */
    public static function echoHTML($return = false)
    {
...
DATA;
    ...
    /**
         ...
         *          等待时间或者状态码
         */
    public static function start($dir, $time = -1)
    {
        self::$ctt = '';
        self::$url = '';
        self::$srt = '';
    ...
    /**
         ...
         *          控制信息
         */
    public static function doing($d)
    {
        self::$srt = $d;
    }
    /**
    ...
    /**
         ...
         * @return void
         */
    public static function response_show($msg, $url = null, $time = 2)
    {
